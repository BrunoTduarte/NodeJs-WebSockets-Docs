...
function tratarAutorizacaoSucesso (payLoandToken) {
  selecionarDocumento({nomeDocumento, nomeUsuario: payLoandToken.nomeUsuario});

};

function atualizaInterfaceUsuarios (usuariosNoDocumentos) {
